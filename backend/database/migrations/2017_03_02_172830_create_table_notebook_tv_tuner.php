...
class CreateTableNotebookTvTuner extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('notebook_tv_tuner', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('notebook_tv_tuner', function ($table) {
