...
"use strict";!function(){var e=$("#chooseClientField"),a=$(".choose-client__client"),t=$("#chooseClientNotFound"),n=$("#clientInfo"),i=$("#chooseClientAddOrder");e.keyup(function(e){o(e.target.value)}),$.each(a,function(e,a){$(a).click(function(){d(a)})});var d=function(e){$.each(a,function(e,a){$(a).removeClass("active")}),$(e).addClass("active"),n.find("#clientInfoSecondName").text($(e).data("second_name")?$(e).data("second_name"):"-"),n.find("#clientInfoFirstName").text($(e).data("first_name")?$(e).data("first_name"):"-"),n.find("#clientInfoFatherName").text($(e).data("father_name")?$(e).data("father_name"):"-"),n.find("#clientInfoOrganization").text($(e).data("organization")?$(e).data("organization"):"-"),n.find("#clientInfoMobilePhone").text($(e).data("mobile_phone_native")?$(e).data("mobile_phone_native"):"-"),n.find("#clientInfoHomePhone").text($(e).data("home_phone_native")?$(e).data("home_phone_native"):"-"),n.find("#clientInfoAddress").text($(e).data("address")?$(e).data("address"):"-"),n.find("#clientInfoRepairs").text($(e).data("repairs")?$(e).data("repairs"):"-"),n.find("#clientInfoLastRepair").text($(e).data("last-repair")?$(e).data("last-repair"):"-"),i.attr("href",i.attr("href").substr(0,i.attr("href").indexOf("client_id=")+"client_id=".length)+$(e).data("id"))},o=function(e){e=e.toLowerCase();var n=-1;$.each(a,function(t,i){var o=-1,r=$(i).data("first_name").toLowerCase();-1===(o=($(i).data("second_name").toLowerCase()+" "+r+" "+$(i).data("father_name").toLowerCase()).indexOf(e))&&(o=$(i).data("organization").toLowerCase().indexOf(e));if(-1===o){o=$(i).data("mobile_phone").toString().indexOf(e)}if(-1===o){o=$(i).data("home_phone").toString().indexOf(e)}-1!==o?(a.eq(t).removeClass("hidden"),-1===n&&d(i),n++):a.eq(t).addClass("hidden")}),-1===n?(t.addClass("active"),t.removeClass("hidden")):(t.removeClass("active"),t.addClass("hidden"))}}();
"use strict";!function(){$.getJSON("/api/repairs",function(t){var e=[];$.each(t,function(t,a){e[t]=[],$.each(a,function(a,n){e[t].unshift(n)})});var a=["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"],n=document.getElementById("repairChart");new Chart(n,{type:"line",data:{datasets:[{label:"Колличество клиентов за 2017 г.",data:e[2017]}],labels:a.slice(0,e[2017].length)},options:{}})})}();