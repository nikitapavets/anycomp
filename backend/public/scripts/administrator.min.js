...
var createDict = function () {
  ...
  var iframeDocument;
  iframe.style.display = 'none';
  __webpack_require__(405).appendChild(iframe);
  iframe.src = 'javascript:'; // eslint-disable-line no-script-url
  // createDict = iframe.contentWindow.Object;
  // html.removeChild(iframe);
  iframeDocument = iframe.contentWindow.document;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _classCallCheck2 = __webpack_require__(35);var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _createClass2 = __webpack_require__(36);var _createClass3 = _interopRequireDefault(_createClass2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var Elements = function () {function Elements() {(0, _classCallCheck3.default)(this, Elements);}(0, _createClass3.default)(Elements, [{ key: 'hideElement', value: function hideElement(
        element) {
...
var has = __webpack_require__(50);
var toIObject = __webpack_require__(34);
var arrayIndexOf = __webpack_require__(390)(false);
var IE_PROTO = __webpack_require__(115)('IE_PROTO');
...
var $iterCreate = __webpack_require__(403);
...
var _getOwnPropertyDescriptor = __webpack_require__(421);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends2 = __webpack_require__(162);var _extends3 = _interopRequireDefault(_extends2);var _stringify = __webpack_require__(85);var _stringify2 = _interopRequireDefault(_stringify);var _getPrototypeOf = __webpack_require__(57);var _getPrototypeOf2 = _interopRequireDefault(_getPrototypeOf);var _classCallCheck2 = __webpack_require__(35);var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _createClass2 = __webpack_require__(36);var _createClass3 = _interopRequireDefault(_createClass2);var _possibleConstructorReturn2 = __webpack_require__(65);var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);var _inherits2 = __webpack_require__(66);var _inherits3 = _interopRequireDefault(_inherits2);var _Elements2 = __webpack_require__(127);var _Elements3 = _interopRequireDefault(_Elements2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
FlexibleTable = function (_Elements) {(0, _inherits3.default)(FlexibleTable, _Elements);

    function FlexibleTable(table) {var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};(0, _classCallCheck3.default)(this, FlexibleTable);var _this = (0, _possibleConstructorReturn3.default)(this, (FlexibleTable.__proto__ || (0, _getPrototypeOf2.default)(FlexibleTable)).call(this));


        _this.config = config;
        _this.table = table;
        _this.modelId = table.dataset.modelId;
        _this.link = table.dataset.link;
        _this.cellsNames = JSON.parse(table.dataset.cellsNames);
        _this.buttons = {
    ...
    }(0, _createClass3.default)(FlexibleTable, [{ key: 'setEventListeners', value: function setEventListeners()

        {var _this2 = this;
            this.checkers = [].slice.call(this.table.querySelectorAll(classes.checker));
            this.checkers.map(function (checker) {
                checker.querySelector('input').onclick = function () {
                    checker.classList.toggle('checked');
                    var checkedCheckers = _this2.checkers.filter(function (checker) {return (
                    ...
                    } else if (_this2.checkers.length - 1 === checkedCheckers.length) {
            ...
            this.mainChecker.querySelector('input').onchange = function () {
                [].slice.call(_this2.table.querySelectorAll(classes.checker)).map(function (checker) {
                    if (~_this2.mainChecker.querySelector('span').className.indexOf('checked')) {
            ...
            var removeButton = this.table.parentNode.querySelector(classes.removeButton);
            if (removeButton) {
                removeButton.onclick = function (event) {
                    [].slice.call(_this2.table.querySelectorAll(classes.checker + '.checked')).map(function (checker) {
                        if (!checker.closest(classes.mainChecker)) {
                            var rowId = checker.closest('tr').dataset.id;
                            checker.closest('tr').remove();
                            _this2.destroy(rowId);
                        }
                    });
                    _this2.mainChecker.querySelector(classes.checker).classList.remove('checked');

                    event.preventDefault();
                };
            }
        } }, { key: 'makeCell', value: function makeCell()

        {var innerHtml = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
            var cell = document.createElement('td');
            cell.innerHTML = innerHtml;
            return cell;
        } }, { key: 'makeCheckerCell', value: function makeCheckerCell()

        {
            ...
            var cell = this.makeCell(checkersHtml);
            cell.className = 'flexibleTable__checker';
            return cell;
        } }, { key: 'makeRow', value: function makeRow()

        {
            var row = document.createElement('tr');
            row.appendChild(this.makeCheckerCell());
            return row;
        } }, { key: 'attachRow', value: function attachRow(
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(263));
...
__webpack_require__(6) && $export($export.P + __webpack_require__(79), 'Object', {
...
var $export = __webpack_require__(0);
var invoke = __webpack_require__(71);
var partial = __webpack_require__(375);
...
"use strict";
var _FlexibleTableFlex = __webpack_require__(384);var _FlexibleTableFlex2 = _interopRequireDefault(_FlexibleTableFlex);
var _FlexibleTableSearch = __webpack_require__(431);var _FlexibleTableSearch2 = _interopRequireDefault(_FlexibleTableSearch);
var _Sender = __webpack_require__(433);var _Sender2 = _interopRequireDefault(_Sender);
var _Checker = __webpack_require__(435);var _Checker2 = _interopRequireDefault(_Checker);
var _flatpickr = __webpack_require__(436);var _flatpickr2 = _interopRequireDefault(_flatpickr);
var _ru = __webpack_require__(437);var _ru2 = _interopRequireDefault(_ru);
__webpack_require__(438);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

(function () {

    var flexibleTablesFlex = [].slice.call(document.querySelectorAll('.flexibleTable.flex'));
    flexibleTablesFlex.map(function (table) {
        new _FlexibleTableFlex2.default(table);

    });

    var flexibleTablesSearch = [].slice.call(document.querySelectorAll('.flexibleTable.search'));
    flexibleTablesSearch.map(function (table) {
        new _FlexibleTableSearch2.default(table, {
            searcher: {
                id: 'searchSpare',
    ...
    var senders = [].slice.call(document.querySelectorAll('.sender'));
    senders.map(function (senderContainer) {
        new _Sender2.default(senderContainer);
    });

    var checkers = [].slice.call(document.querySelectorAll('.checker'));
    checkers.map(function (checkerContainer) {
        new _Checker2.default(checkerContainer);
    });
     ...
     */
    (0, _flatpickr2.default)('.widget__DatePicker', {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends2 = __webpack_require__(162);var _extends3 = _interopRequireDefault(_extends2);var _stringify = __webpack_require__(85);var _stringify2 = _interopRequireDefault(_stringify);var _getPrototypeOf = __webpack_require__(57);var _getPrototypeOf2 = _interopRequireDefault(_getPrototypeOf);var _classCallCheck2 = __webpack_require__(35);var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _createClass2 = __webpack_require__(36);var _createClass3 = _interopRequireDefault(_createClass2);var _possibleConstructorReturn2 = __webpack_require__(65);var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);var _get2 = __webpack_require__(175);var _get3 = _interopRequireDefault(_get2);var _inherits2 = __webpack_require__(66);var _inherits3 = _interopRequireDefault(_inherits2);var _FlexibleTable2 = __webpack_require__(176);var _FlexibleTable3 = _interopRequireDefault(_FlexibleTable2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
FlexibleTableFlex = function (_FlexibleTable) {(0, _inherits3.default)(FlexibleTableFlex, _FlexibleTable);

    function FlexibleTableFlex(table) {(0, _classCallCheck3.default)(this, FlexibleTableFlex);return (0, _possibleConstructorReturn3.default)(this, (FlexibleTableFlex.__proto__ || (0, _getPrototypeOf2.default)(FlexibleTableFlex)).call(this,
        table));
    }(0, _createClass3.default)(FlexibleTableFlex, [{ key: 'setEventListeners', value: function setEventListeners()

        {var _this2 = this;
            (0, _get3.default)(FlexibleTableFlex.prototype.__proto__ || (0, _getPrototypeOf2.default)(FlexibleTableFlex.prototype), 'setEventListeners', this).call(this);

            Array.prototype.slice.call(this.table.querySelectorAll('td')).map(function (cell) {
                var row = cell.parentNode;
                var editBtn = cell.querySelector(classes.editButton);
                var editInput = cell.querySelector(classes.editInput);
                var currentValue = cell.querySelector(classes.currentValue);
                if (editBtn) {
            ...
            var addButton = this.table.parentNode.querySelector(classes.addButton);
            if (addButton) {
                addButton.onclick = function (event) {
                    var cellDefaultValues = JSON.parse(_this2.table.dataset.defaultValues);
                    var row = _this2.makeNewRow(_this2.cellsNames, cellDefaultValues);
                    var tbody = _this2.table.querySelector('tbody');
                    if (tbody) {
                        tbody.append(row);
                        _this2.mainChecker.querySelector(classes.checker).classList.remove('checked');
        ...
        } }, { key: 'makeNewRow', value: function makeNewRow(

        cellNames) {var cellDefaultValues = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
            var row = document.createElement('tr');
            ...
            cellNames.map(function (cellName, position) {
                var cell = document.createElement('td');
        ...
        row) {
            ...
            var newValues = {};
            [].map.call(row.querySelectorAll('input[type="text"]'), function (input) {
            ...
            if (rowId) {
                ...
                this.store(newValues).then(function (newRowId) {return row.dataset.id = newRowId;});
            }
        } }, { key: 'store', value: function store(
        ...
        id) {
            ...
            then(function (response) {return response.json();});
        } }]);return FlexibleTableFlex;}(_FlexibleTable3.default);exports.default = FlexibleTableFlex;
...
// true  -> Array#includes
var toIObject = __webpack_require__(34);
var toLength = __webpack_require__(391);
var toAbsoluteIndex = __webpack_require__(392);
module.exports = function (IS_INCLUDES) {
  return function ($this, el, fromIndex) {
    var O = toIObject($this);
    var length = toLength(O.length);
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(55)(IteratorPrototype, __webpack_require__(58)('iterator'), function () { return this; });
...
var $export = __webpack_require__(47);
var redefine = __webpack_require__(173);
var META = __webpack_require__(413).KEY;
var $fails = __webpack_require__(56);
...
var enumKeys = __webpack_require__(415);
...
__webpack_require__(170)('getOwnPropertyDescriptor', function () {
  return function getOwnPropertyDescriptor(it, key) {
    return $getOwnPropertyDescriptor(toIObject(it), key);
  };
});
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(163)(Function.call, __webpack_require__(126).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _stringify = __webpack_require__(85);var _stringify2 = _interopRequireDefault(_stringify);var _getPrototypeOf = __webpack_require__(57);var _getPrototypeOf2 = _interopRequireDefault(_getPrototypeOf);var _classCallCheck2 = __webpack_require__(35);var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _createClass2 = __webpack_require__(36);var _createClass3 = _interopRequireDefault(_createClass2);var _possibleConstructorReturn2 = __webpack_require__(65);var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);var _get2 = __webpack_require__(175);var _get3 = _interopRequireDefault(_get2);var _inherits2 = __webpack_require__(66);var _inherits3 = _interopRequireDefault(_inherits2);var _FlexibleTable2 = __webpack_require__(176);var _FlexibleTable3 = _interopRequireDefault(_FlexibleTable2);
var _Searcher = __webpack_require__(432);var _Searcher2 = _interopRequireDefault(_Searcher);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var

FlexibleTableSearch = function (_FlexibleTable) {(0, _inherits3.default)(FlexibleTableSearch, _FlexibleTable);

    function FlexibleTableSearch(table) {var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};(0, _classCallCheck3.default)(this, FlexibleTableSearch);var _this = (0, _possibleConstructorReturn3.default)(this, (FlexibleTableSearch.__proto__ || (0, _getPrototypeOf2.default)(FlexibleTableSearch)).call(this,
        table, config));

        _this.searcher = new _Searcher2.default(config.searcher.id, {
            title: config.searcher.title,
            link: config.searcher.link,
            callback: function callback(model) {
                _this.attachRow(_this.makeRow(model));
                _this.store({
                    repair_id: _this.modelId,
                    spare_id: model.id }).
                then(function (id) {return console.log(id);});
            } });return _this;

    }(0, _createClass3.default)(FlexibleTableSearch, [{ key: 'setEventListeners', value: function setEventListeners()

        {var _this2 = this;
            (0, _get3.default)(FlexibleTableSearch.prototype.__proto__ || (0, _getPrototypeOf2.default)(FlexibleTableSearch.prototype), 'setEventListeners', this).call(this);
            if (this.buttons.add) {
                this.buttons.add.onclick = function (event) {
                    _this2.searcher.open();
                    event.preventDefault();
                };
            }
            if (this.buttons.remove) {
                this.buttons.remove.onclick = function (event) {
                    [].slice.call(_this2.table.querySelectorAll(classes.checker + '.checked')).map(function (checker) {
                        if (!checker.closest(classes.mainChecker)) {
                            var rowId = checker.closest('tr').dataset.id;
                            checker.closest('tr').remove();
                            _this2.destroy({
                                repair_id: _this2.modelId,
                                spare_id: rowId });
        ...
        model) {var _this3 = this;
            var row = (0, _get3.default)(FlexibleTableSearch.prototype.__proto__ || (0, _getPrototypeOf2.default)(FlexibleTableSearch.prototype), 'makeRow', this).call(this);
            row.dataset.id = model.id;
            this.cellsNames.map(function (_) {return row.appendChild(_this3.makeCell(model[_]));});
            return row;
        } }, { key: 'destroy', value: function destroy(
        ...
        data) {
            ...
            then(function (response) {return response.json();}).
            then(function (json) {return json.id;});
        } }]);return FlexibleTableSearch;}(_FlexibleTable3.default);exports.default = FlexibleTableSearch;
...
var icons = {
    'save': '#admin_plus_595959' };var


Searcher = function (_Elements) {(0, _inherits3.default)(Searcher, _Elements);
    function Searcher(id) {var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultConfig;(0, _classCallCheck3.default)(this, Searcher);var _this = (0, _possibleConstructorReturn3.default)(this, (Searcher.__proto__ || (0, _getPrototypeOf2.default)(Searcher)).call(this));


        _this.config = config;
        _this.container = _this.make(id);
        document.body.appendChild(_this.container);return _this;
    }(0, _createClass3.default)(Searcher, [{ key: 'make', value: function make(
        ...
        id) {var _this2 = this;
            ...
            var searcherTitle = document.createElement('div');
            ...
            var searcherField = document.createElement('div');
            ...
            var searcherResults = document.createElement('div');
            searcherResults.className = classes.searcherResults;
            searcher.appendChild(searcherResults);
            this.results = searcherResults;

            return container;
        } }, { key: 'makeInput', value: function makeInput()

        {var _this3 = this;
            var searcherFieldInput = document.createElement('input');
            searcherFieldInput.className = classes.searcherFieldInput;
            this.input = searcherFieldInput;

            searcherFieldInput.onkeyup = function (event) {
                if (event.keyCode === 13) {
                    if (_this3.config.link) {
                        _this3.send(_this3.config.link, _this3.input.value);
                    }
                }
            };

            return searcherFieldInput;
        } }, { key: 'makeButton', value: function makeButton()

        {var _this4 = this;
            var searcherFieldBtn = document.createElement('button');
            ...
            searcherFieldBtn.onclick = function (event) {
                if (_this4.config.link) {
                    _this4.send(_this4.config.link, _this4.input.value);
                }
                event.preventDefault();
            };

            return searcherFieldBtn;
        } }, { key: 'makeResultRow', value: function makeResultRow(

        result) {var _this5 = this;
            ...
            addBtn.onclick = function (event) {
                _this5.hideElement(_this5.container);
                _this5.config.callback(result);
                event.preventDefault();
            };
            row.appendChild(addBtn);
            row.onmouseenter = function () {
                _this5.showElement(addBtn);
            };
            row.onmouseleave = function () {
                _this5.hideElement(addBtn);
            };

            return row;
        } }, { key: 'makeGag', value: function makeGag()


        {
            var gag = document.createElement('span');
            gag.className = classes.searcherGag;
            gag.innerText = this.config.searchGag || defaultConfig.searchGag;
            return gag;
        } }, { key: 'fillResults', value: function fillResults(

        results) {var _this6 = this;
            ...
            results.map(function (result) {
                _this6.results.appendChild(_this6.makeResultRow(result));
            });

        } }, { key: 'send', value: function send(

        link, data) {var _this7 = this;
            return fetch(link + '?search=' + data, {
                method: 'get' }).

            then(function (response) {return response.json();}).
            then(function (json) {return _this7.fillResults(json);});
        } }, { key: 'open', value: function open()

        {
            this.showElement(this.container);
        } }]);return Searcher;}(_Elements3.default);exports.default = Searcher;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _classCallCheck2 = __webpack_require__(35);var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _createClass2 = __webpack_require__(36);var _createClass3 = _interopRequireDefault(_createClass2);var _Api = __webpack_require__(434);var _Api2 = _interopRequireDefault(_Api);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var defaultClasses = {
    'pusher': '.sender__push' };var


Sender = function () {
    function Sender(container) {(0, _classCallCheck3.default)(this, Sender);
        ...
        this.setEventListeners();
    }(0, _createClass3.default)(Sender, [{ key: 'setEventListeners', value: function setEventListeners()

        {var _this = this;
            this.pushers.map(function (pusher) {
                pusher.addEventListener('click', function (event) {
                    _Api2.default.post(_this.link, pusher.dataset);
                    _this.pushers.map(function (_) {return _.classList.remove('active');});
                    pusher.classList.add('active');
                    event.preventDefault();
                });
            });
        } }]);return Sender;}();exports.default = Sender;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _stringify = __webpack_require__(85);var _stringify2 = _interopRequireDefault(_stringify);var _classCallCheck2 = __webpack_require__(35);var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _createClass2 = __webpack_require__(36);var _createClass3 = _interopRequireDefault(_createClass2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var Api = function () {function Api() {(0, _classCallCheck3.default)(this, Api);}(0, _createClass3.default)(Api, null, [{ key: 'post', value: function post(
        link) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
            return fetch(link, {
                method: "post",
                headers: {
                    'Accept': 'application/json',
...
Checker = function (_Elements) {(0, _inherits3.default)(Checker, _Elements);
    function Checker(input) {(0, _classCallCheck3.default)(this, Checker);var _this = (0, _possibleConstructorReturn3.default)(this, (Checker.__proto__ || (0, _getPrototypeOf2.default)(Checker)).call(this));


        _this.input = input;
        _this.container = input.parentNode;
        _this.makeGag();
        _this.setEventListeners();return _this;
    }(0, _createClass3.default)(Checker, [{ key: 'makeGag', value: function makeGag()
        ...
        } }, { key: 'setEventListeners', value: function setEventListeners()

        {var _this2 = this;
            this.input.addEventListener('click', function (event) {
                _this2.gag.classList.toggle(defaultClasses.checked);
            });
        } }]);return Checker;}(_Elements3.default);exports.default = Checker;
...
var update = __webpack_require__(441)(content, options);
...
var	fixUrls = __webpack_require__(442);
